      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="原料编号" prop="yuanliaobianhao">
          <el-input v-model="ruleForm.yuanliaobianhao" 
              placeholder="原料编号" clearable  :readonly="ro.yuanliaobianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="原料编号" prop="yuanliaobianhao">
              <el-input v-model="ruleForm.yuanliaobianhao" 
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yuanliaoruku/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yuanliaorukuCrossAddOrUpdateFlag = false;
                  this.parent.search();
