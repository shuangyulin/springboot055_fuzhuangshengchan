<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="任职时间" prop="renzhishijian">
          <el-input v-model="ruleForm.renzhishijian" 
              placeholder="任职时间" clearable  :readonly="ro.renzhishijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="任职时间" prop="renzhishijian">
              <el-input v-model="ruleForm.renzhishijian" 
                placeholder="任职时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhaopian = true;
          ...
          if(o=='renzhishijian'){
            this.ruleForm.renzhishijian = obj[o];
	    this.ro.renzhishijian = true;
            continue;
          }
          if(o=='beizhu'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `renshianpai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.renshianpaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
