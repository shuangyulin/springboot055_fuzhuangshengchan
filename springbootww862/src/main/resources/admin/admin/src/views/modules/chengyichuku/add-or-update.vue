<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="成品编号" prop="chengpinbianhao">
          <el-input v-model="ruleForm.chengpinbianhao" 
              placeholder="成品编号" clearable  :readonly="ro.chengpinbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="成品编号" prop="chengpinbianhao">
              <el-input v-model="ruleForm.chengpinbianhao" 
                placeholder="成品编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="是否合格" prop="shifouhege">
          <el-input v-model="ruleForm.shifouhege" 
              placeholder="是否合格" clearable  :readonly="ro.shifouhege"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="检验人" prop="jianyanren">
          <el-input v-model="ruleForm.jianyanren" 
              placeholder="检验人" clearable  :readonly="ro.jianyanren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="检验人" prop="jianyanren">
              <el-input v-model="ruleForm.jianyanren" 
                placeholder="检验人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="检验时间" prop="jianyanshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.jianyanshijian" 
                type="datetime"
                placeholder="检验时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jianyanshijian" label="检验时间" prop="jianyanshijian">
              <el-input v-model="ruleForm.jianyanshijian" 
                placeholder="检验时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出库去向" prop="chukuquxiang">
          <el-input v-model="ruleForm.chukuquxiang" 
              placeholder="出库去向" clearable  :readonly="ro.chukuquxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出库去向" prop="chukuquxiang">
              <el-input v-model="ruleForm.chukuquxiang" 
                placeholder="出库去向" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	chengpinbianhao : false,
	chengpinmingcheng : false,
	shifouhege : false,
	jianyanren : false,
	jianyanshijian : false,
	shuliang : false,
	chukushijian : false,
	chukuquxiang : false,
      },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='chengpinbianhao'){
            this.ruleForm.chengpinbianhao = obj[o];
	    this.ro.chengpinbianhao = true;
            continue;
          }
	    ...
	    this.ro.shifouhege = true;
          ...
          if(o=='jianyanren'){
            this.ruleForm.jianyanren = obj[o];
	    this.ro.jianyanren = true;
            continue;
          }
          if(o=='jianyanshijian'){
            this.ruleForm.jianyanshijian = obj[o];
	    this.ro.jianyanshijian = true;
            continue;
          }
          if(o=='shuliang'){
	    ...
	    this.ro.chukushijian = true;
          ...
          if(o=='chukuquxiang'){
            this.ruleForm.chukuquxiang = obj[o];
	    this.ro.chukuquxiang = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `chengyichuku/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chengyichukuCrossAddOrUpdateFlag = false;
                  this.parent.search();
